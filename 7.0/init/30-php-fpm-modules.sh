...
if [ \( "${PHP_MODULES_ALL:-1}" != 0 -a -z "${PHP_FPM_MODULES_ALL}" \) -o \( "${PHP_FPM_MODULES_ALL}" != 0 -a -n "${PHP_FPM_MODULES_ALL}" \) ]; then
	...
	[ \( "${PHP_MODULE_APCU_BC:-1}" = 0 -a -z "${PHP_FPM_MODULE_APCU_BC}" \) -o "${PHP_FPM_MODULE_APCU_BC:-1}" = 0 ] && rm -f $CONF/25-apcu_bc.ini || ln -sf $MODS/apcu_bc.ini $CONF/25-apcu_bc.ini
	[ \( "${PHP_MODULE_AST:-1}" = 0 -a -z "${PHP_FPM_MODULE_AST}" \) -o "${PHP_FPM_MODULE_AST:-1}" = 0 ] && rm -f $CONF/20-ast.ini || ln -sf $MODS/ast.ini $CONF/20-ast.ini
	...
	[ \( "${PHP_MODULE_FACEDETECT:-1}" = 0 -a -z "${PHP_FPM_MODULE_FACEDETECT}" \) -o "${PHP_FPM_MODULE_FACEDETECT:-1}" = 0 ] && rm -f $CONF/20-facedetect.ini || ln -sf $MODS/facedetect.ini $CONF/20-facedetect.ini
	...
	[ \( "${PHP_MODULE_FTP:-1}" = 0 -a -z "${PHP_FPM_MODULE_FTP}" \) -o "${PHP_FPM_MODULE_FTP:-1}" = 0 ] && rm -f $CONF/20-ftp.ini || ln -sf $MODS/ftp.ini $CONF/20-ftp.ini
	[ \( "${PHP_MODULE_GD:-1}" = 0 -a -z "${PHP_FPM_MODULE_GD}" \) -o "${PHP_FPM_MODULE_GD:-1}" = 0 ] && rm -f $CONF/20-gd.ini || ln -sf $MODS/gd.ini $CONF/20-gd.ini
	[ \( "${PHP_MODULE_GEARMAN:-1}" = 0 -a -z "${PHP_FPM_MODULE_GEARMAN}" \) -o "${PHP_FPM_MODULE_GEARMAN:-1}" = 0 ] && rm -f $CONF/20-gearman.ini || ln -sf $MODS/gearman.ini $CONF/20-gearman.ini
	[ \( "${PHP_MODULE_GEOIP:-1}" = 0 -a -z "${PHP_FPM_MODULE_GEOIP}" \) -o "${PHP_FPM_MODULE_GEOIP:-1}" = 0 ] && rm -f $CONF/20-geoip.ini || ln -sf $MODS/geoip.ini $CONF/20-geoip.ini
	[ \( "${PHP_MODULE_GETTEXT:-1}" = 0 -a -z "${PHP_FPM_MODULE_GETTEXT}" \) -o "${PHP_FPM_MODULE_GETTEXT:-1}" = 0 ] && rm -f $CONF/20-gettext.ini || ln -sf $MODS/gettext.ini $CONF/20-gettext.ini
	[ \( "${PHP_MODULE_GMAGICK:-1}" = 0 -a -z "${PHP_FPM_MODULE_GMAGICK}" \) -o "${PHP_FPM_MODULE_GMAGICK:-1}" = 0 ] && rm -f $CONF/20-gmagick.ini || ln -sf $MODS/gmagick.ini $CONF/20-gmagick.ini
	...
	[ \( "${PHP_MODULE_IMAP:-1}" = 0 -a -z "${PHP_FPM_MODULE_IMAP}" \) -o "${PHP_FPM_MODULE_IMAP:-1}" = 0 ] && rm -f $CONF/20-imap.ini || ln -sf $MODS/imap.ini $CONF/20-imap.ini
	...
	[ \( "${PHP_MODULE_INTERBASE:-1}" = 0 -a -z "${PHP_FPM_MODULE_INTERBASE}" \) -o "${PHP_FPM_MODULE_INTERBASE:-1}" = 0 ] && rm -f $CONF/20-interbase.ini || ln -sf $MODS/interbase.ini $CONF/20-interbase.ini
	...
	[ \( "${PHP_MODULE_MBSTRING:-1}" = 0 -a -z "${PHP_FPM_MODULE_MBSTRING}" \) -o "${PHP_FPM_MODULE_MBSTRING:-1}" = 0 ] && rm -f $CONF/20-mbstring.ini || ln -sf $MODS/mbstring.ini $CONF/20-mbstring.ini
	[ \( "${PHP_MODULE_MCRYPT:-1}" = 0 -a -z "${PHP_FPM_MODULE_MCRYPT}" \) -o "${PHP_FPM_MODULE_MCRYPT:-1}" = 0 ] && rm -f $CONF/20-mcrypt.ini || ln -sf $MODS/mcrypt.ini $CONF/20-mcrypt.ini
	[ \( "${PHP_MODULE_MEMCACHE:-1}" = 0 -a -z "${PHP_FPM_MODULE_MEMCACHE}" \) -o "${PHP_FPM_MODULE_MEMCACHE:-1}" = 0 ] && rm -f $CONF/20-memcache.ini || ln -sf $MODS/memcache.ini $CONF/20-memcache.ini
	[ \( "${PHP_MODULE_MEMCACHED:-1}" = 0 -a -z "${PHP_FPM_MODULE_MEMCACHED}" \) -o "${PHP_FPM_MODULE_MEMCACHED:-1}" = 0 ] && rm -f $CONF/25-memcached.ini || ln -sf $MODS/memcached.ini $CONF/25-memcached.ini
	[ \( "${PHP_MODULE_MONGODB:-1}" = 0 -a -z "${PHP_FPM_MODULE_MONGODB}" \) -o "${PHP_FPM_MODULE_MONGODB:-1}" = 0 ] && rm -f $CONF/20-mongodb.ini || ln -sf $MODS/mongodb.ini $CONF/20-mongodb.ini
	[ \( "${PHP_MODULE_MSGPACK:-1}" = 0 -a -z "${PHP_FPM_MODULE_MSGPACK}" \) -o "${PHP_FPM_MODULE_MSGPACK:-1}" = 0 ] && rm -f $CONF/20-msgpack.ini || ln -sf $MODS/msgpack.ini $CONF/20-msgpack.ini
	...
	[ \( "${PHP_MODULE_PDO_FIREBIRD:-1}" = 0 -a -z "${PHP_FPM_MODULE_PDO_FIREBIRD}" \) -o "${PHP_FPM_MODULE_PDO_FIREBIRD:-1}" = 0 ] && rm -f $CONF/20-pdo_firebird.ini || ln -sf $MODS/pdo_firebird.ini $CONF/20-pdo_firebird.ini
	[ \( "${PHP_MODULE_PDO_MYSQL:-1}" = 0 -a -z "${PHP_FPM_MODULE_PDO_MYSQL}" \) -o "${PHP_FPM_MODULE_PDO_MYSQL:-1}" = 0 ] && rm -f $CONF/20-pdo_mysql.ini || ln -sf $MODS/pdo_mysql.ini $CONF/20-pdo_mysql.ini
	[ \( "${PHP_MODULE_PDO_ODBC:-1}" = 0 -a -z "${PHP_FPM_MODULE_PDO_ODBC}" \) -o "${PHP_FPM_MODULE_PDO_ODBC:-1}" = 0 ] && rm -f $CONF/20-pdo_odbc.ini || ln -sf $MODS/pdo_odbc.ini $CONF/20-pdo_odbc.ini
	...
	[ \( "${PHP_MODULE_PHALCON:-1}" = 0 -a -z "${PHP_FPM_MODULE_PHALCON}" \) -o "${PHP_FPM_MODULE_PHALCON:-1}" = 0 ] && rm -f $CONF/20-phalcon.ini || ln -sf $MODS/phalcon.ini $CONF/20-phalcon.ini
	...
	[ \( "${PHP_MODULE_RADIUS:-1}" = 0 -a -z "${PHP_FPM_MODULE_RADIUS}" \) -o "${PHP_FPM_MODULE_RADIUS:-1}" = 0 ] && rm -f $CONF/20-radius.ini || ln -sf $MODS/radius.ini $CONF/20-radius.ini
	...
	[ \( "${PHP_MODULE_SMBCLIENT:-1}" = 0 -a -z "${PHP_FPM_MODULE_SMBCLIENT}" \) -o "${PHP_FPM_MODULE_SMBCLIENT:-1}" = 0 ] && rm -f $CONF/20-smbclient.ini || ln -sf $MODS/smbclient.ini $CONF/20-smbclient.ini
	[ \( "${PHP_MODULE_SNMP:-1}" = 0 -a -z "${PHP_FPM_MODULE_SNMP}" \) -o "${PHP_FPM_MODULE_SNMP:-1}" = 0 ] && rm -f $CONF/20-snmp.ini || ln -sf $MODS/snmp.ini $CONF/20-snmp.ini
	[ \( "${PHP_MODULE_SOAP:-1}" = 0 -a -z "${PHP_FPM_MODULE_SOAP}" \) -o "${PHP_FPM_MODULE_SOAP:-1}" = 0 ] && rm -f $CONF/20-soap.ini || ln -sf $MODS/soap.ini $CONF/20-soap.ini
	[ \( "${PHP_MODULE_SOCKETS:-1}" = 0 -a -z "${PHP_FPM_MODULE_SOCKETS}" \) -o "${PHP_FPM_MODULE_SOCKETS:-1}" = 0 ] && rm -f $CONF/20-sockets.ini || ln -sf $MODS/sockets.ini $CONF/20-sockets.ini
	[ \( "${PHP_MODULE_SODIUM:-1}" = 0 -a -z "${PHP_FPM_MODULE_SODIUM}" \) -o "${PHP_FPM_MODULE_SODIUM:-1}" = 0 ] && rm -f $CONF/20-sodium.ini || ln -sf $MODS/sodium.ini $CONF/20-sodium.ini
	...
	[ \( "${PHP_MODULE_WDDX:-1}" = 0 -a -z "${PHP_FPM_MODULE_WDDX}" \) -o "${PHP_FPM_MODULE_WDDX:-1}" = 0 ] && rm -f $CONF/20-wddx.ini || ln -sf $MODS/wddx.ini $CONF/20-wddx.ini
	...
	[ \( "${PHP_MODULE_XHPROF:-1}" = 0 -a -z "${PHP_FPM_MODULE_XHPROF}" \) -o "${PHP_FPM_MODULE_XHPROF:-1}" = 0 ] && rm -f $CONF/20-xhprof.ini || ln -sf $MODS/xhprof.ini $CONF/20-xhprof.ini
	[ \( "${PHP_MODULE_XML:-1}" = 0 -a -z "${PHP_FPM_MODULE_XML}" \) -o "${PHP_FPM_MODULE_XML:-1}" = 0 ] && rm -f $CONF/15-xml.ini || ln -sf $MODS/xml.ini $CONF/15-xml.ini
	[ \( "${PHP_MODULE_XMLREADER:-1}" = 0 -a -z "${PHP_FPM_MODULE_XMLREADER}" \) -o "${PHP_FPM_MODULE_XMLREADER:-1}" = 0 ] && rm -f $CONF/20-xmlreader.ini || ln -sf $MODS/xmlreader.ini $CONF/20-xmlreader.ini
	[ \( "${PHP_MODULE_XMLRPC:-1}" = 0 -a -z "${PHP_FPM_MODULE_XMLRPC}" \) -o "${PHP_FPM_MODULE_XMLRPC:-1}" = 0 ] && rm -f $CONF/20-xmlrpc.ini || ln -sf $MODS/xmlrpc.ini $CONF/20-xmlrpc.ini
	[ \( "${PHP_MODULE_XMLWRITER:-1}" = 0 -a -z "${PHP_FPM_MODULE_XMLWRITER}" \) -o "${PHP_FPM_MODULE_XMLWRITER:-1}" = 0 ] && rm -f $CONF/20-xmlwriter.ini || ln -sf $MODS/xmlwriter.ini $CONF/20-xmlwriter.ini
	[ \( "${PHP_MODULE_XSL:-1}" = 0 -a -z "${PHP_FPM_MODULE_XSL}" \) -o "${PHP_FPM_MODULE_XSL:-1}" = 0 ] && rm -f $CONF/20-xsl.ini || ln -sf $MODS/xsl.ini $CONF/20-xsl.ini
	[ \( "${PHP_MODULE_YAC:-1}" = 0 -a -z "${PHP_FPM_MODULE_YAC}" \) -o "${PHP_FPM_MODULE_YAC:-1}" = 0 ] && rm -f $CONF/20-yac.ini || ln -sf $MODS/yac.ini $CONF/20-yac.ini
	...
	[ \( "${PHP_MODULE_APCU_BC:-0}" != 0 -a -z "${PHP_FPM_MODULE_APCU_BC}" \) -o "${PHP_FPM_MODULE_APCU_BC:-0}" != 0 ] && ln -sf $MODS/apcu_bc.ini $CONF/25-apcu_bc.ini || rm -f $CONF/25-apcu_bc.ini
	[ \( "${PHP_MODULE_AST:-0}" != 0 -a -z "${PHP_FPM_MODULE_AST}" \) -o "${PHP_FPM_MODULE_AST:-0}" != 0 ] && ln -sf $MODS/ast.ini $CONF/20-ast.ini || rm -f $CONF/20-ast.ini
	...
	[ \( "${PHP_MODULE_FACEDETECT:-0}" != 0 -a -z "${PHP_FPM_MODULE_FACEDETECT}" \) -o "${PHP_FPM_MODULE_FACEDETECT:-0}" != 0 ] && ln -sf $MODS/facedetect.ini $CONF/20-facedetect.ini || rm -f $CONF/20-facedetect.ini
	...
	[ \( "${PHP_MODULE_FTP:-0}" != 0 -a -z "${PHP_FPM_MODULE_FTP}" \) -o "${PHP_FPM_MODULE_FTP:-0}" != 0 ] && ln -sf $MODS/ftp.ini $CONF/20-ftp.ini || rm -f $CONF/20-ftp.ini
	[ \( "${PHP_MODULE_GD:-0}" != 0 -a -z "${PHP_FPM_MODULE_GD}" \) -o "${PHP_FPM_MODULE_GD:-0}" != 0 ] && ln -sf $MODS/gd.ini $CONF/20-gd.ini || rm -f $CONF/20-gd.ini
	[ \( "${PHP_MODULE_GEARMAN:-0}" != 0 -a -z "${PHP_FPM_MODULE_GEARMAN}" \) -o "${PHP_FPM_MODULE_GEARMAN:-0}" != 0 ] && ln -sf $MODS/gearman.ini $CONF/20-gearman.ini || rm -f $CONF/20-gearman.ini
	[ \( "${PHP_MODULE_GEOIP:-0}" != 0 -a -z "${PHP_FPM_MODULE_GEOIP}" \) -o "${PHP_FPM_MODULE_GEOIP:-0}" != 0 ] && ln -sf $MODS/geoip.ini $CONF/20-geoip.ini || rm -f $CONF/20-geoip.ini
	[ \( "${PHP_MODULE_GETTEXT:-0}" != 0 -a -z "${PHP_FPM_MODULE_GETTEXT}" \) -o "${PHP_FPM_MODULE_GETTEXT:-0}" != 0 ] && ln -sf $MODS/gettext.ini $CONF/20-gettext.ini || rm -f $CONF/20-gettext.ini
	[ \( "${PHP_MODULE_GMAGICK:-0}" != 0 -a -z "${PHP_FPM_MODULE_GMAGICK}" \) -o "${PHP_FPM_MODULE_GMAGICK:-0}" != 0 ] && ln -sf $MODS/gmagick.ini $CONF/20-gmagick.ini || rm -f $CONF/20-gmagick.ini
	...
	[ \( "${PHP_MODULE_IMAP:-0}" != 0 -a -z "${PHP_FPM_MODULE_IMAP}" \) -o "${PHP_FPM_MODULE_IMAP:-0}" != 0 ] && ln -sf $MODS/imap.ini $CONF/20-imap.ini || rm -f $CONF/20-imap.ini
	...
	[ \( "${PHP_MODULE_INTERBASE:-0}" != 0 -a -z "${PHP_FPM_MODULE_INTERBASE}" \) -o "${PHP_FPM_MODULE_INTERBASE:-0}" != 0 ] && ln -sf $MODS/interbase.ini $CONF/20-interbase.ini || rm -f $CONF/20-interbase.ini
	...
	[ \( "${PHP_MODULE_MBSTRING:-0}" != 0 -a -z "${PHP_FPM_MODULE_MBSTRING}" \) -o "${PHP_FPM_MODULE_MBSTRING:-0}" != 0 ] && ln -sf $MODS/mbstring.ini $CONF/20-mbstring.ini || rm -f $CONF/20-mbstring.ini
	[ \( "${PHP_MODULE_MCRYPT:-0}" != 0 -a -z "${PHP_FPM_MODULE_MCRYPT}" \) -o "${PHP_FPM_MODULE_MCRYPT:-0}" != 0 ] && ln -sf $MODS/mcrypt.ini $CONF/20-mcrypt.ini || rm -f $CONF/20-mcrypt.ini
	[ \( "${PHP_MODULE_MEMCACHE:-0}" != 0 -a -z "${PHP_FPM_MODULE_MEMCACHE}" \) -o "${PHP_FPM_MODULE_MEMCACHE:-0}" != 0 ] && ln -sf $MODS/memcache.ini $CONF/20-memcache.ini || rm -f $CONF/20-memcache.ini
	[ \( "${PHP_MODULE_MEMCACHED:-0}" != 0 -a -z "${PHP_FPM_MODULE_MEMCACHED}" \) -o "${PHP_FPM_MODULE_MEMCACHED:-0}" != 0 ] && ln -sf $MODS/memcached.ini $CONF/25-memcached.ini || rm -f $CONF/25-memcached.ini
	[ \( "${PHP_MODULE_MONGODB:-0}" != 0 -a -z "${PHP_FPM_MODULE_MONGODB}" \) -o "${PHP_FPM_MODULE_MONGODB:-0}" != 0 ] && ln -sf $MODS/mongodb.ini $CONF/20-mongodb.ini || rm -f $CONF/20-mongodb.ini
	[ \( "${PHP_MODULE_MSGPACK:-0}" != 0 -a -z "${PHP_FPM_MODULE_MSGPACK}" \) -o "${PHP_FPM_MODULE_MSGPACK:-0}" != 0 ] && ln -sf $MODS/msgpack.ini $CONF/20-msgpack.ini || rm -f $CONF/20-msgpack.ini
	...
	[ \( "${PHP_MODULE_PDO_FIREBIRD:-0}" != 0 -a -z "${PHP_FPM_MODULE_PDO_FIREBIRD}" \) -o "${PHP_FPM_MODULE_PDO_FIREBIRD:-0}" != 0 ] && ln -sf $MODS/pdo_firebird.ini $CONF/20-pdo_firebird.ini || rm -f $CONF/20-pdo_firebird.ini
	[ \( "${PHP_MODULE_PDO_MYSQL:-0}" != 0 -a -z "${PHP_FPM_MODULE_PDO_MYSQL}" \) -o "${PHP_FPM_MODULE_PDO_MYSQL:-0}" != 0 ] && ln -sf $MODS/pdo_mysql.ini $CONF/20-pdo_mysql.ini || rm -f $CONF/20-pdo_mysql.ini
	[ \( "${PHP_MODULE_PDO_ODBC:-0}" != 0 -a -z "${PHP_FPM_MODULE_PDO_ODBC}" \) -o "${PHP_FPM_MODULE_PDO_ODBC:-0}" != 0 ] && ln -sf $MODS/pdo_odbc.ini $CONF/20-pdo_odbc.ini || rm -f $CONF/20-pdo_odbc.ini
	...
	[ \( "${PHP_MODULE_PHALCON:-0}" != 0 -a -z "${PHP_FPM_MODULE_PHALCON}" \) -o "${PHP_FPM_MODULE_PHALCON:-0}" != 0 ] && ln -sf $MODS/phalcon.ini $CONF/20-phalcon.ini || rm -f $CONF/20-phalcon.ini
	...
	[ \( "${PHP_MODULE_RADIUS:-0}" != 0 -a -z "${PHP_FPM_MODULE_RADIUS}" \) -o "${PHP_FPM_MODULE_RADIUS:-0}" != 0 ] && ln -sf $MODS/radius.ini $CONF/20-radius.ini || rm -f $CONF/20-radius.ini
	...
	[ \( "${PHP_MODULE_SMBCLIENT:-0}" != 0 -a -z "${PHP_FPM_MODULE_SMBCLIENT}" \) -o "${PHP_FPM_MODULE_SMBCLIENT:-0}" != 0 ] && ln -sf $MODS/smbclient.ini $CONF/20-smbclient.ini || rm -f $CONF/20-smbclient.ini
	[ \( "${PHP_MODULE_SNMP:-0}" != 0 -a -z "${PHP_FPM_MODULE_SNMP}" \) -o "${PHP_FPM_MODULE_SNMP:-0}" != 0 ] && ln -sf $MODS/snmp.ini $CONF/20-snmp.ini || rm -f $CONF/20-snmp.ini
	[ \( "${PHP_MODULE_SOAP:-0}" != 0 -a -z "${PHP_FPM_MODULE_SOAP}" \) -o "${PHP_FPM_MODULE_SOAP:-0}" != 0 ] && ln -sf $MODS/soap.ini $CONF/20-soap.ini || rm -f $CONF/20-soap.ini
	[ \( "${PHP_MODULE_SOCKETS:-0}" != 0 -a -z "${PHP_FPM_MODULE_SOCKETS}" \) -o "${PHP_FPM_MODULE_SOCKETS:-0}" != 0 ] && ln -sf $MODS/sockets.ini $CONF/20-sockets.ini || rm -f $CONF/20-sockets.ini
	[ \( "${PHP_MODULE_SODIUM:-0}" != 0 -a -z "${PHP_FPM_MODULE_SODIUM}" \) -o "${PHP_FPM_MODULE_SODIUM:-0}" != 0 ] && ln -sf $MODS/sodium.ini $CONF/20-sodium.ini || rm -f $CONF/20-sodium.ini
	...
	[ \( "${PHP_MODULE_WDDX:-0}" != 0 -a -z "${PHP_FPM_MODULE_WDDX}" \) -o "${PHP_FPM_MODULE_WDDX:-0}" != 0 ] && ln -sf $MODS/wddx.ini $CONF/20-wddx.ini || rm -f $CONF/20-wddx.ini
	...
	[ \( "${PHP_MODULE_XHPROF:-0}" != 0 -a -z "${PHP_FPM_MODULE_XHPROF}" \) -o "${PHP_FPM_MODULE_XHPROF:-0}" != 0 ] && ln -sf $MODS/xhprof.ini $CONF/20-xhprof.ini || rm -f $CONF/20-xhprof.ini
	[ \( "${PHP_MODULE_XML:-0}" != 0 -a -z "${PHP_FPM_MODULE_XML}" \) -o "${PHP_FPM_MODULE_XML:-0}" != 0 ] && ln -sf $MODS/xml.ini $CONF/15-xml.ini || rm -f $CONF/15-xml.ini
	[ \( "${PHP_MODULE_XMLREADER:-0}" != 0 -a -z "${PHP_FPM_MODULE_XMLREADER}" \) -o "${PHP_FPM_MODULE_XMLREADER:-0}" != 0 ] && ln -sf $MODS/xmlreader.ini $CONF/20-xmlreader.ini || rm -f $CONF/20-xmlreader.ini
	[ \( "${PHP_MODULE_XMLRPC:-0}" != 0 -a -z "${PHP_FPM_MODULE_XMLRPC}" \) -o "${PHP_FPM_MODULE_XMLRPC:-0}" != 0 ] && ln -sf $MODS/xmlrpc.ini $CONF/20-xmlrpc.ini || rm -f $CONF/20-xmlrpc.ini
	[ \( "${PHP_MODULE_XMLWRITER:-0}" != 0 -a -z "${PHP_FPM_MODULE_XMLWRITER}" \) -o "${PHP_FPM_MODULE_XMLWRITER:-0}" != 0 ] && ln -sf $MODS/xmlwriter.ini $CONF/20-xmlwriter.ini || rm -f $CONF/20-xmlwriter.ini
	[ \( "${PHP_MODULE_XSL:-0}" != 0 -a -z "${PHP_FPM_MODULE_XSL}" \) -o "${PHP_FPM_MODULE_XSL:-0}" != 0 ] && ln -sf $MODS/xsl.ini $CONF/20-xsl.ini || rm -f $CONF/20-xsl.ini
	[ \( "${PHP_MODULE_YAC:-0}" != 0 -a -z "${PHP_FPM_MODULE_YAC}" \) -o "${PHP_FPM_MODULE_YAC:-0}" != 0 ] && ln -sf $MODS/yac.ini $CONF/20-yac.ini || rm -f $CONF/20-yac.ini

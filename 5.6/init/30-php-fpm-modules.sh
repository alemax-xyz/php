...
if [ \( "${PHP_MODULES_ALL:-1}" != 0 -a -z "${PHP_FPM_MODULES_ALL}" \) -o \( "${PHP_FPM_MODULES_ALL}" != 0 -a -n "${PHP_FPM_MODULES_ALL}" \) ]; then
	...
	[ \( "${PHP_MODULE_MONGO:-1}" = 0 -a -z "${PHP_FPM_MODULE_MONGO}" \) -o "${PHP_FPM_MODULE_MONGO:-1}" = 0 ] && rm -f $CONF/20-mongo.ini || ln -sf $MODS/mongo.ini $CONF/20-mongo.ini
	...
	[ \( "${PHP_MODULE_MSSQL:-1}" = 0 -a -z "${PHP_FPM_MODULE_MSSQL}" \) -o "${PHP_FPM_MODULE_MSSQL:-1}" = 0 ] && rm -f $CONF/20-mssql.ini || ln -sf $MODS/mssql.ini $CONF/20-mssql.ini
	...
	[ \( "${PHP_MODULE_XCACHE:-1}" = 0 -a -z "${PHP_FPM_MODULE_XCACHE}" \) -o "${PHP_FPM_MODULE_XCACHE:-1}" = 0 ] && rm -f $CONF/20-xcache.ini || ln -sf $MODS/xcache.ini $CONF/20-xcache.ini
	...
	[ \( "${PHP_MODULE_MONGO:-0}" != 0 -a -z "${PHP_FPM_MODULE_MONGO}" \) -o "${PHP_FPM_MODULE_MONGO:-0}" != 0 ] && ln -sf $MODS/mongo.ini $CONF/20-mongo.ini || rm -f $CONF/20-mongo.ini
	...
	[ \( "${PHP_MODULE_MSSQL:-0}" != 0 -a -z "${PHP_FPM_MODULE_MSSQL}" \) -o "${PHP_FPM_MODULE_MSSQL:-0}" != 0 ] && ln -sf $MODS/mssql.ini $CONF/20-mssql.ini || rm -f $CONF/20-mssql.ini
	...
	[ \( "${PHP_MODULE_XCACHE:-0}" != 0 -a -z "${PHP_FPM_MODULE_XCACHE}" \) -o "${PHP_FPM_MODULE_XCACHE:-0}" != 0 ] && ln -sf $MODS/xcache.ini $CONF/20-xcache.ini || rm -f $CONF/20-xcache.ini

...
(
	...
	if [ -n "${PHP_FPM_BLACKFIRE_AGENT_TIMEOUT+1}" ]; then 
		echo "blackfire.agent_timeout=\"${PHP_FPM_BLACKFIRE_AGENT_TIMEOUT}\""
	elif [ -n "${PHP_BLACKFIRE_AGENT_TIMEOUT+1}" ]; then
		echo "blackfire.agent_timeout=\"${PHP_BLACKFIRE_AGENT_TIMEOUT}\""
	fi
